...
inputs4 <- list(username='<username>', password='<password>', submit='Log In')
inputs5 <- list(vb_login_username='<username>', vb_login_password='<password>', 
                do='login', cookieuser='1', s="<s>", securitytoken="<security_token>",
